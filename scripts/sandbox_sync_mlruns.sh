...
experiment_folder=/mnt/c/Users/gop7rng/Documents/thesis/src/plm_enriched_attention/mlruns/5/

rsync -av --progress gop7rng@si-dl01-login01.de.bosch.com:thesis/src/plm_enriched_attention_sandbox/mlruns/\
